...
export default function LibrarianBooks() { return <View style={s.flex}><View style={s.center}><MaterialIcons name="menu-book" size={56} color={Colors.textMuted} /><Text style={s.title}>Book Catalog</Text><Text style={s.sub}>Full catalog management visible on the Library dashboard.</Text></View><BottomNav items={NAV} accentColor="#E65100" /></View>; }

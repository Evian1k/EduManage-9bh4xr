...
export default function BursarFees() { return <View style={s.flex}><View style={s.center}><MaterialIcons name="receipt-long" size={56} color={Colors.textMuted} /><Text style={s.title}>Fee Structures</Text><Text style={s.sub}>Manage fee structures from Finance dashboard.</Text></View><BottomNav items={NAV} accentColor="#43A047" /></View>; }

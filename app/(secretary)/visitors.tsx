...
export default function SecretaryVisitors() {
  return (
    <View style={s.flex}>
      <View style={s.center}>
        <MaterialIcons name="badge" size={56} color={Colors.textMuted} />
        <Text style={s.title}>Visitor Log</Text>
        <Text style={s.sub}>Full visitor management available on the Reception tab.</Text>
      </View>
...
const s = StyleSheet.create({
  ...
  sub: { fontSize: FontSize.base, color: Colors.textMuted, textAlign: 'center', paddingHorizontal: 40 },
});

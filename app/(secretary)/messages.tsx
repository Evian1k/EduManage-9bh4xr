...
export default function SecretaryMessages() {
  return <View style={s.flex}><View style={s.center}><MaterialIcons name="mail" size={56} color={Colors.textMuted} /><Text style={s.title}>Messaging</Text><Text style={s.sub}>Internal messaging system coming soon.</Text></View><BottomNav items={NAV} accentColor="#00897B" /></View>;
}

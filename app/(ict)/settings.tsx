...
export default function ICTSettings() { return <View style={s.flex}><View style={s.center}><MaterialIcons name="settings" size={56} color={Colors.textMuted} /><Text style={s.title}>System Settings</Text><Text style={s.sub}>Technical configuration coming soon.</Text></View><BottomNav items={NAV} accentColor="#7B1FA2" /></View>; }

...
export default function ICTLogs() { return <View style={s.flex}><View style={s.center}><MaterialIcons name="list-alt" size={56} color={Colors.textMuted} /><Text style={s.title}>Access Logs</Text><Text style={s.sub}>Audit logs visible on ICT dashboard.</Text></View><BottomNav items={NAV} accentColor="#7B1FA2" /></View>; }
